...
if (isset($_POST["btnSubmit"])) {
    ...
    $post = filter_var($_POST["txtPost"], FILTER_SANITIZE_EMAIL);
    $dataRecord[] = $post;
    ...
    if (!$errorMsg) {
        ...
        $data2 = array($homemade, $healthy, $budget, $vegan, $gluten, $post, $title, $skill,$hash);
...
// display any error messages before we print out the form
    ...
    <?php if ($emailERROR) print 'class="mistake"'; ?>
                        ...
                        <fieldset class="radio">
                            <legend>What is your baking level?</legend>
    ...
    <?php if ($skill == "Intermediate") print 'checked' ?>
                            ...
                            <label><input type="radio" 
                                          id="radPro" 
                                          name="radSkill" 
                                          value="Profesional/Commercial"
    <?php if ($skill == "Profesional/Commercial") print 'checked' ?>
                                          tabindex="340">Profesional/Commercial</label></label>
                        </fieldset>
